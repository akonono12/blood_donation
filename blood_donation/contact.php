    ...
    <div class="container" style="margin-top:70px;">
			...
			<div class="row">
				...
				<?php
					...
					{
					 $sql="INSERT INTO h_mssg (Name, Contact, Email, Message, Status,Logs) VALUES ('{$_POST["Name"]}', '{$_POST["Contact"]}', '{$_POST["Email"]}', '{$_POST["Message"]}', 1,NOW());";
						if($con->query($sql))
				{
					echo '
                ...
                <form method="post" action="contact.php" role="form" >
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" name="Name" placeholder="Input Complete Name..." required>
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="Email" class="form-control" name="Email" placeholder="Input Complete Email Address..."  >
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
