...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            // Attempt to execute the prepared statement
            if(mysqli_stmt_execute($stmt)){
                // Redirect to h_login_form page
                header("location: h_login_form.php");
            } else{
...
?>
 <?php include"hsignup_head.php";?>
<html>
<?php include"hsignup_top_nav.php";?>
<img src="images/donate.jpg" id="bg" >
<style>
#bg {
  position: fixed; 
  top: 0; 
...
<center id="bg">
    <div class="wrapper" ><br><br><br>
		...
		<h2>Hospital Sign up form</h2><br><br>
